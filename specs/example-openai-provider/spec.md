...
Currently, Ansible Sage only supports Claude (Anthropic) as an LLM provider. Many users prefer or require OpenAI's GPT models due to:
...
- [Ansible Sage BaseLLMProvider](../sage/core/providers/base.py)
