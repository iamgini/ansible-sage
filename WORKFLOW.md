# Ansible Sage - Workflow Documentation

## Overview

**Ansible Sage generates playbooks and pushes them to Git. It does NOT execute playbooks.**
...
Ansible Sage calculates a confidence score (0.0 - 1.0) for each generated playbook based on:
...
After Ansible Sage pushes to Git, **you** control execution:
...
- This is expected! Ansible Sage only generates and publishes
- Check your AAP/CI/CD pipeline configuration
- Verify branch monitoring is enabled

---

**Remember**: Ansible Sage is a **generation and publishing tool**, not an execution engine. It produces high-quality, validated playbooks and commits them to Git for your existing automation pipeline to handle execution with appropriate controls and approvals.
