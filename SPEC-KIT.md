# Ansible Sage - Spec-Kit Implementation Guide

This document describes how to use [GitHub Spec-Kit](https://github.com/github/spec-kit) for specification-driven development of Ansible Sage features.
...
```bash
cd /home/gmadappa/ansible/ansible-sage
...
### 1. GitOps First
- **No Execution**: Ansible Sage NEVER executes playbooks
...
This constitution guides all development decisions for Ansible Sage.
```
...
- [ ] Add "Generated by Ansible Sage" footer
...
- Running Molecule on the Ansible Sage server (should use containers)
```
...
## Integration with Existing Ansible Sage
...
Perfect for Ansible Sage's systematic, safety-critical development needs.

**Next Steps**:
1. `npm install -g @github/spec-kit`
2. `specify init ansible-sage`
